...
def load_repo_data():
    ...
    print("✅ Repo loaded:", len(latest))


# ===============================
# FILTERS
# ===============================
#EXTERNAL_KEYWORDS = ["mongo", "mysql", "ntop", "nprobe", "ndpi", "pfring", "python", "py", "zypper", "xserver", "xmms2-plugin", "xubuntu", "xfonts", "xf", "xfs", "sp", "sq", "sql", "s", "ruby", "rt", "rsy
"""
META_PACKAGES = {
